...
$app->post('/apiv1/editoriales/nuevo', function (Request $request, Response $res, array $args) {
...
$app->put('/apiv1/editoriales/{id}', function (Request $request, Response $res, array $args) {
    $request = Utileria::PasarAJson(file_get_contents('php://input'));
